...
class BD_API  { 
       ...
       public function __construct(){
			...
			if ($this->function!="login" && (!isset($_SESSION['login']) || $_SESSION['login']=="")  && $this->function != "findTablaAuxFilter") {
			    header('HTTP/1.1 500 La sesión ha caducado. Debe volver a identificarse');
