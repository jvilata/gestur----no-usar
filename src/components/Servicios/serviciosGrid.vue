...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'descripcionCorta', align: 'left', label: 'descripcionCorta', field: 'descripcionCorta', sortable: true },
        { name: 'descripcionLarga', align: 'left', label: 'descripcionLarga', field: 'descripcionLarga', sortable: true },
        { name: 'tipoIva', align: 'left', label: 'tipoIva', field: 'tipoIva', sortable: true },
        { name: 'numero', align: 'left', label: 'Numero', field: 'Numero', sortable: true },
        {
          name: 'tipoServicio',
          align: 'left',
          label: 'tipoServicio',
  ...
  methods: {
    ...
    ...mapActions('servicios', ['borrarTablaAux', 'addServicios', 'borrarServicio']),
